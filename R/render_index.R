...
render_index <- function(index_file = "index", subdir = "reports"){
  ...
  rmarkdown::render(index_path, output_format = "ENRanalytics::enr_index", output_file = "index.html", quiet = T)
  rmarkdown::render(index_path, output_format = "ENRanalytics::enr_tooltip", output_file = "_tooltip_content.html", quiet = T)
  rmarkdown::render(index_path, output_format = "ENRanalytics::enr_header", output_file = "_header.html", quiet = T)
